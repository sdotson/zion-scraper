...
if (currentMonth === 2) {
	monthTableSelector = '#cs_idCell2x1x1 table tr:nth-of-type(12) table';
} else if (currentMonth === 3) {
	monthTableSelector = '#cs_idCell2x1x1 table tr:nth-of-type(10) td:nth-of-type(2) table';
} else if (currentMonth === 4) {
	monthTableSelector = '#cs_idCell2x1x1 table tr:nth-of-type(10) td:nth-of-type(1) table';
}
	...
	checkPermits: function(options) {
		...
		options.permits.forEach(function(campsite) {
			...
			casper.waitForSelector("#cs_idCell2x1x1 table tr table", function () {
			    var days = this.evaluate(getAvailability, monthTableSelector),
