...
if (currentMonth === 2) {
	monthTableSelector = '#cs_idCell2x1x1 table tr:nth-of-type(10) table';
} else if (currentMonth === 3) {
	monthTableSelector = '#cs_idCell2x1x1 table tr:nth-of-type(8) td:nth-of-type(2) table';
} else if (currentMonth === 4) {
	monthTableSelector = '#cs_idCell2x1x1 table tr:nth-of-type(8) td:nth-of-type(1) table';
}
